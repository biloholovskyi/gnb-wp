...
<div class="preloader"><img class="preloader__img" alt="hidden" src="https://wallpapercave.com/wp/wp6470963.jpg">
  ...
  <div class="preloader__text">Управление механизации №1</div>
</div>
<header class="header header--content">
  <div class="header__left">
    <a class="header__logo" href="/">
      <img src="<?php echo get_template_directory_uri() . '/media/icon/logo-color.svg'; ?>" alt="GBN" class="logo__img" data-link="<?php echo get_template_directory_uri(); ?>">
      <div class="logo__text">Управление механизации №1</div>
    </a>
  ...
  <div class="header__right">
    ...
    ?>
    <div class="main-button main-button--color btn-to-form">Связаться с нами</div>
  </div>
